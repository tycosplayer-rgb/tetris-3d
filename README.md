...
| Input | Action |
|-------|--------|
| **Swipe / drag** | Move the falling piece on the footprint (XZ). Directions match the **tilted camera**: screen-left = left from your view, screen-up = deeper into the well. |
